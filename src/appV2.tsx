...
const PublicOne = React.memo((props: RouteComponentProps) => {
  return <div>public one</div>;
});

const PublicTwo = React.memo((props: RouteComponentProps) => {
  return <div><p>public two</p></div>;
});
  ...
  return (
    <Provider store={store}>
      <Router history={history}>
        <PublicRoute exact path="/login" component={PublicOne} />
        <PublicRoute exact path="/signup" component={PublicTwo} />
